...
public class CreditScreen implements Screen{
    ...
    public CreditScreen(Game game){
        ...
        Label gameOverLabel = new Label("DAVID PRADOS MANCILLA", font);
        Label gameOverLabel2 = new Label("pradosman@gmail.com", font);
        Label playAgainLabel = new Label("Pulsa Para Volver", font);
