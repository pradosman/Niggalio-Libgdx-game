...
public class Turtle extends Enemy {
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        setBounds(getX(), getY(), 16 / Niggalio.PPM, 24 / Niggalio.PPM);
    ...
    protected void defineEnemy() {
        ...
        fdef.filter.categoryBits = Niggalio.ENEMY_BIT;
        ...
        vertice[0] = new Vector2(-5, 8).scl(1 / Niggalio.PPM);
        vertice[1] = new Vector2(5, 8).scl(1 / Niggalio.PPM);
        vertice[2] = new Vector2(-3, 3).scl(1 / Niggalio.PPM);
        vertice[3] = new Vector2(3, 3).scl(1 / Niggalio.PPM);
        head.set(vertice);

        fdef.shape = head;
        fdef.restitution = 1.8f;
        fdef.filter.categoryBits = Niggalio.ENEMY_HEAD_BIT;
        b2body.createFixture(fdef).setUserData(this);
    }
    ...
    public void update(float dt) {
        ...
        setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - 8 /Niggalio.PPM);
        b2body.setLinearVelocity(velocity);
    }

    @Override
    public void hitOnHead(Nigga mario) {
