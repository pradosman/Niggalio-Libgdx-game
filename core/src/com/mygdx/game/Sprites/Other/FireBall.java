...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / Niggalio.PPM, 6 / Niggalio.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /Niggalio.PPM : getX() - 12 /Niggalio.PPM, getY());
        ...
        shape.setRadius(3 / Niggalio.PPM);
        fdef.filter.categoryBits = Niggalio.FIREBALL_BIT;
